...
`;function je({question:o,questionId:t,createdAt:n,petition:r,answer:i,client:a}){const[d,l]=c.exports.useState(!1),u=new Date(parseInt(n));return s(v,{children:[d&&e(Pe,{setDetail:l,date:u,petition:r,question:o,answer:i}),s(Ue,{children:[e("h4",{children:r}),e("span",{children:u.toLocaleString()}),e("div",{children:s("p",{children:[e("b",{children:"Cliente:"})," ",a]})}),e("p",{onClick:()=>l(!0),children:o}),e("div",{className:"answer",onClick:()=>l(!0),children:i.length>0&&i.map(g=>e(P,{admin:g.admin.username,answer:g.answer},g.id))}),e(Me,{questionId:t})]})]})}const Ue=p.div`
padding: 30px 20px;
margin: 10px;
box-shadow: rgba(0, 0, 0, 0.2) 0px 1px 2px 0px;
background-color: #f2f2ff;
...
`;function Oe(){var n;const{data:o,error:t}=A(de,{pollInterval:2e3});return console.log("data",o),t?null:e("div",{children:o&&((n=o.allQuestion)==null?void 0:n.map(r=>e(je,{client:r.client.username,question:r.question,questionId:r.id,createdAt:r.createdAt,petition:r.petition.name,answer:r.answer},r.id)))})}function _e(){return e(He,{children:e(Oe,{})})}const He=p.div`
flex: .5;
margin: auto;
overflow-y: auto;
@media(max-width: 1000px){
